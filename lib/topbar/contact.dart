...
class ContactTopBarContents extends StatefulWidget {
	ContactTopBarContents({
		super.key
	});

	@override
	_ContactTopBarContentsState createState() => _ContactTopBarContentsState();
}

class _ContactTopBarContentsState extends State<ContactTopBarContents> {
