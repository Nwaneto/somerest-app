...
class SomerestBaseSidebar extends StatefulWidget {
	@override
	SomerestBaseSidebarState createState() => SomerestBaseSidebarState();
}

class SomerestBaseSidebarState extends State<SomerestBaseSidebar> {
	String _name = "Hello";
